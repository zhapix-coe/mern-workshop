...
const InternForm = ({
  ...
  const validateForm = () => {
    ...
    if (!internName.trim()) newErrors.internName = "Name is required.";
    ...
    if (!internStream) newErrors.internStream = "Stream is required.";
    if (gradStatus === null) newErrors.gradStatus = "Graduate status is required.";
    if (!internStatus) newErrors.internStatus = "Status is required.";
    if (!internPlace.trim()) newErrors.internPlace = "Place is required.";
